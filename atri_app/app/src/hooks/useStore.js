...
const desktopModeProps = {
  ...
  "Home": {
        ...
        "onClick": [
          {
            "navigate": {
              "type": "external",
              "url": "https://www.flaticon.com/free-icons/arrow",
              "target": "_blank"
            }
          }
        ]
    ...
    "TextBox9": {
      "custom": {
        "text": "I design poducts that delight and inspire people."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image14": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/5fef58435ceaed068dde60ca_Group%2016.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox24": {
      "custom": {
        "text": "Every designer needs the right tools to do the perfect job. I'm multilingual."
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image18": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/5fef584362e74acfa6b75398_Group%2051.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image31": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/left%20arrow.png"
      },
      "callbacks": {
        "onClick": [
          {
